...
function fetchMeal(type){
  ...
  if ( type === 'r' ) {
      ...
      .then( res => {
          ...
          if (res.meals) {
              $("#errorMessageSection").remove();
              $("#random .container").show();
